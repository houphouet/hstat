  ...
  createPlot <- shiny::reactive({
    ...
    p <- p +
      ...
      ggplot2::theme(
        ...
        axis.title.x  = ggtext::element_markdown(face = x_axis_face, size = input$axisLabelSize %||% 12),
        axis.title.y  = ggtext::element_markdown(face = y_axis_face, size = input$axisLabelSize %||% 12),
